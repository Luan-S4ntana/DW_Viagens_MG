...
CREATE TABLE TB_DIARIA (
  ...
  CONSTRAINT FK_LOCAL_ORIGEM FOREIGN KEY (COD_LOCAL_ORIGEM) REFERENCES TB_CIDADE (COD_LOCAL_ORIGEM),
  CONSTRAINT FK_LOCAL_DESTINO FOREIGN KEY (COD_LOCAL_DESTINO) REFERENCES TB_CIDADE (COD_LOCAL_DESTINO),

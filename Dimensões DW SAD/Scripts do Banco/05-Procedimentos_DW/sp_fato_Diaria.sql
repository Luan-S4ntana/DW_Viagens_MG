...
BEGIN
    ...
    DECLARE @COD_LOCAL_ORIGEM INT
    DECLARE @COD_LOCAL_DESTINO INT 
    ...
    OPEN CUR
    FETCH NEXT FROM CUR INTO @COD_PASSAGEM, @DATA_COMPRA, @DATA_PARTIDA, @DATA_CHEGADA, @QUANTIDADE_DIARIAS, @VALOR, @COD_LOCAL_ORIGEM, @COD_LOCAL_DESTINO, @COD_FUNCIONARIO, @COD_ORGAO_SCDP, @COD_MEIO_DE_TRANSPORTE, @COD_TPO_DE_VIAGEM, @COD_MOTIVO_VIAGEM
